...
{
    // 逐字移植（2026-08-06）：Client/MirControls/MirDropDownBox.cs
    // 下拉框：折叠显示选中项 + 展开 5 行选项列表（>5 带滚动条），鼠标悬停/点击/离开语义逐字保留。
    public class MirDropDownBox : MirControl
    {
        ...
        protected override void OnSizeChanged()
        {
            ...
            {
                _Option[i].Size = new Size(Size.Width - 16, 16);
            }

            if (_label != null && !_label.IsDisposed)
                _label.Size = new Size(Size.Width - 16, 15);
