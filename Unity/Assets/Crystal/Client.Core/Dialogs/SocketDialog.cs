...
{
    // 逐字移植（2026-08-06）：Client/MirScenes/Dialogs/SocketDialog.cs
    // 打孔镶嵌对话框：Prguse3 框体（Index=20 起，随槽数 Index+），6×2 槽网格（GridType=Socket），
    // 槽数量由 SelectedItem.Slots 长度决定。Show 时挂到背包/装备窗下方。
