...
{
    // 逐字移植（2026-08-06）：Client/MirScenes/Dialogs/ChatOptionDialog.cs
    // 聊天设置对话框：Title 466 框体双 tab（筛选/透明），9 个频道筛选按钮 + 透明开关。
    // CheckAllFilters/ToggleAllFilters 联动 GameScene.Scene.ChatDialog.Update()（Unity seam 已应用 8 个 filter）。
