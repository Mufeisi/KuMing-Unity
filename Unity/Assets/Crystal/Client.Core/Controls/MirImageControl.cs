...
{
    // 逐字移植（2026-08-05）：Client/MirControls/MirImageControl.cs
    // 去 DXManager.SetGrayscale：灰度开关保留（Blending 路径语义），实际生效由渲染层
    // CrystalSpriteBatch 的 SetGrayscale 处理（MLibraryUnity DrawBlend 内核），此处仅转发 Draw。
