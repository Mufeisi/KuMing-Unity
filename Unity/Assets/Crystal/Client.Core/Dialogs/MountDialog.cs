...
{
    // 逐字移植（2026-08-06）：Client/MirScenes/Dialogs/MountDialog.cs
    // 宠物/坐骑对话框：坐骑动画（MirAnimatedControl，StartIndex+MountType*20 帧序列）+
    // 5 格坐骑装备（MirGridType.Mount，依 MountSlots.Length 切 4/5 槽布局）+
    // Ride@ride 指令 + NoMount 提示（MirMessageBox）+ Help 帮助页。
