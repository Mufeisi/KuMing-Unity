...
{
    // 逐字移植（2026-08-06）：Client/MirScenes/Dialogs/HelpDialog.cs
    // 帮助窗口：Prguse 920 框体 + 44 页（前 3 页快捷键列表 ShortcutPage1/2/3，其余 Help 图集图片页）。
    // 依赖：Libraries.Help（图集产物已有）+ CMain.InputKeys.GetKey（迭代包10 InputKeys seam）+ 全量 ClientTextKeys。
